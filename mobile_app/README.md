...
`flutter analyze` currently crashes in this Windows environment due to a Flutter
3.44 analysis-server/tool issue, so `dart analyze lib test` is used as the
code-level analyzer check.
