...
**Current experiment:** 2 — resnet50_v2_balanced_sampler
**Current step:** about to launch training
**Elapsed:** ~0.25 h
**FAILED list:** (none — exp1 completed as FAIL result, not an error)
...
| 2 | resnet50_v2_balanced_sampler | resnet50 | ham10000_v2_sampler.yaml | PENDING | 2026-05-24 12:12 |
